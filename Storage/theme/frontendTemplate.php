...
<html data-ng-app="">
  <head>
    ...
    <title>ASI FILE STORAGE SYSTEM</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="#" class="logo">
          ...
          <span class="logo-mini"><b>FSS</b></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>ASI - FSS</b></span>
        </a>
  ...
  ?>
             ...
             <!--        <div class="col-xs-4 text-center">
                    ...
                    <div class="col-xs-4 text-center">
                      ...
                      <center>  
                      <a style="background:black;" href="<?php echo WEB_ROOT; ?>modules/lockscreen/confirmlock.php" class="btn btn-default btn-flat"><i class="fa fa-lock" style="color:white;"></i> <span style="color:white;">LOCK ACCOUNT</span></a>          
                    </center>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <?php
                ...
                <li><a href="<?php echo WEB_ROOT; ?>modules/random/index.php?view=add"><i class="fa fa-plus text-aqua"></i> Add New File</a></li>
                <li><a href="<?php echo WEB_ROOT; ?>modules/random/index.php"><i class="fa fa-search text-aqua"></i> View Item List</a></li>
              ...
              <ul class="treeview-menu">
                <li><a href="<?php echo WEB_ROOT; ?>modules/sign/index.php?view=add"><i class="fa fa-plus text-yellow"></i> Add New File</a></li>
                <li><a href="<?php echo WEB_ROOT; ?>modules/sign/index.php"><i class="fa fa-search text-yellow"></i> View Item List</a></li>
...
/*******************END***********************************************/
      ...
      <footer class="main-footer" id="no">
       ...
       date_default_timezone_set('Asia/Manila');
        ...
        <!-- Default to the left -->
         <strong>Copyright &copy; <?php echo $date; ?> | File Storage System</strong> | Powered by Chris jim Egot | <b>All rights reserved</b>. 
